...
export default class GrowthWeightStaticsCard extends Component<any, any> {
  ...
  _renderBoyGrowthLineChart() {
    const dataList1 = this.state.boysWeight['dataList1'];
    const dataList3 = this.state.boysWeight['dataList3'];
    const dataList4 = this.state.boysWeight['dataList4'];
    const dataList5 = this.state.boysWeight['dataList5'];
    const dataList7 = this.state.boysWeight['dataList7'];
